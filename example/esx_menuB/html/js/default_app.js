(function(){
	...
	ESX_MENU.submit = function(namespace, name, data) {
		exports.ui-wrapper.uiPostMessage("ESX Menu Default B", 'menu_submit', {
	...
	ESX_MENU.cancel = function(namespace, name) {
		exports.ui-wrapper.uiPostMessage("ESX Menu Default B", 'menu_cancel', {
			_namespace: namespace,
			_name: name
		});
	};
	...
	ESX_MENU.change = function(namespace, name, data) {
		exports.ui-wrapper.uiPostMessage("ESX Menu Default B", 'menu_change', {
			_namespace: namespace,
			_name: name,
			current: data,
			elements: ESX_MENU.opened[namespace][name].elements
